...
void PointLight::UselLight(GLfloat ambientIntensityLocation, GLfloat ambientColourLocation, GLfloat diffuseIntensityLocation,
    ...
    glUniform3f(posititionLocation, position.x, position.y, position.z);
